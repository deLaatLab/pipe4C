...
| primer            | Primer sequence (only include the sequence that will be included in the Illumina read, so exclude the Illumina adapter). Use the RE1 motif is the primer sequence untill the RE1 motif is already removed.                                                                                                                                                                       |
